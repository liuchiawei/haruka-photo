  ...
  return (
    <div className="w-full">
      <h1
        ...
        className="text-center text-[4rem] md:text-[9rem] lg:text-[10rem] xl:text-[12rem] 2xl:text-[14rem] font-roboto font-thin tracking-widest uppercase wrap-break-word"
      >
        {t(`categories.${slug}`)}
      </h1>
